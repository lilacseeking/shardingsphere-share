package org.example.read.write.separation.util;
...
public class ResponseUtil {
     ...
     * @param errorMsg 错误信息
     */
    public void putErrorStrAndLog(String errorId,String errorCode, String errorMsg,String logMsg) {
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("errorId",errorId);
        jsonObject.put("message",errorMsg);
        putError(1, errorCode, jsonObject);
        log.error(logMsg + "{}",jsonObject.toJSONString());
    }
